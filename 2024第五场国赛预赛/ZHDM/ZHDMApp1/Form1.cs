...
namespace ZHDMApp1
{
    ...
    {
        ZHData zHData = new ZHData();//数据全局变量
        public Form1()
        {
            InitializeComponent();
        }
        ...
        private void 打开数据ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            if(openFileDialog.ShowDialog()==DialogResult.OK)
            {
                ...
                fileHelp.readfile(zHData, dataGridView1, openFileDialog.FileName);
            }
        ...
        private void 一键处理ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            FileHelp fileHelp = new FileHelp();
            fileHelp.updaterich(richTextBox1, zHData);
            tabControl1.SelectedTab = tabPage2;
        }
        ...
        {
            string text = "如果程序无法正常运行请检查数据格式是否正确";
            string title = "问题解决";
